...
public class EmailReporting {
	...
	public static File getLatestReport() {
		 String sdir = System.getProperty("user.dir") + "\\" + config.getProperty("reportFolder");
	...
	public static String formMailBody(LocalDateTime startTime, LocalDateTime endTime) throws ParseException
	{
		...
		String sb = "<head>" +
                ...
                "<p> Please find below, the automation execution status for " + config.getProperty("Engagement_Name")+" as below:" +"</p>" + "<p>"
                		+ "<table><tr><th>Start Time</th><td>"+dtf.format(startTime)+"</td></tr><tr><th>End Time</th><td>"+dtf.format(endTime)+"</td></tr><tr><th>Test Execution Time</th><td>"+ duration.toHours()+":"+duration.toMinutes()+ "(HH:MM)</td></tr></table><img src=\"cid:image\"><br><br><p>Regards,</p><p>SAG Automation Team</P>";
		return sb;
	}
	...
	public static void loadConfig() {
		try {
			fis = new FileInputStream(
					System.getProperty("user.dir") + "\\src\\test\\resources\\properties\\EmailConfig.properties");
