...
public class DocCollectedTest extends TestBase {
	
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void docCollectedTest(Hashtable<String, String> data) throws Exception {

		if (!(TestUtil.isTestRunnable("docCollectedTest", excel))) {

			throw new SkipException(
					"Skipping the test " + "docCollectedTest".toUpperCase() + "as the Run mode is NO");
		}
