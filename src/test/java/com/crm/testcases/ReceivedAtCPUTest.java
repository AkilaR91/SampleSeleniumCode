...
public class ReceivedAtCPUTest extends TestBase {
	
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void receivedAtCPUTest(Hashtable<String, String> data) throws Exception {

		if (!(TestUtil.isTestRunnable("receivedAtCPUTest", excel))) {

			throw new SkipException(
					"Skipping the test " + "receivedAtCPUTest".toUpperCase() + "as the Run mode is NO");
		}
