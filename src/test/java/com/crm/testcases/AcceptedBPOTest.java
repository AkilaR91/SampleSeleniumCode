...
public class AcceptedBPOTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void acceptedBPOTest(Hashtable<String, String> data) throws Exception {

		if (!(TestUtil.isTestRunnable("acceptedBPOTest", excel))) {

			throw new SkipException(
					"Skipping the test " + "acceptedBPOTest".toUpperCase() + "as the Run mode is NO");
		}
